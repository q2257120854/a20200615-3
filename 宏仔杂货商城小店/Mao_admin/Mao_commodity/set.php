                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select id="type">
                                    ...
                                    <option value="1" <?php if($cha_1['type'] == 1){ echo 'selected=""';}else{}?>>1</option>
                                    <option value="2" <?php if($cha_1['type'] == 2){ echo 'selected=""';}else{}?>>2</option>
                                    <option value="3" <?php if($cha_1['type'] == 3){ echo 'selected=""';}else{}?>>3</option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-form-item">
