...
if($verify_result) {//验证成功
    ...
    if(!$shop){
        ...
        sysmsg('<center>该订单号已完成交易！<br><br>请用下单的手机号码！<br><br>登录查看订单或物流！<br><br><a href="/index.php">【点击我返回首页】</a></center>');
        ...
        sysmsg('<center>交易成功！<br><br>请用下单的手机号码！<br><br>登录查看订单或物流！<br><br><a href="/index.php">【点击我返回首页】</a></center>');
    }else{
