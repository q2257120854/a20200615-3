...
<body>
						...
						<div class="info">
							...
							<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="#ffffff" align="center" class="cfBox">
								<tbody>
									...
									<th width="30%" class="buy_tr">方式</th>
									<th width="20%" class="buy_tr">状态</th>
									<th width="20%" class="buy_tr">时间</th>
									<th width="15%" class="buy_tr">操作</th>
									<?php
 $page = $_GET["page"];
 ...
 $query = "select count(*) as total from qd";
...
if($_curPageNum < $_pageNum && $_end < $pages){
 ...
 ?>
									<?php 
										$sql="select * from qd ORDER BY `id` DESC  limit $offset,$page_size";
										...
										if($result&&mysql_num_rows($result)){
											...
											echo "<td width='20%'' class='buy_tr'>".$row['yw']."</td>";
											echo "<td width='20%'' class='buy_tr'>".$row['time']."</td>";
											echo "<td width='15%'' class='buy_tr'><a href='qiandao-del.php?id=".$row['id']."'>删除</a>
											</td>";
											echo "</tr>";
											}
										}
