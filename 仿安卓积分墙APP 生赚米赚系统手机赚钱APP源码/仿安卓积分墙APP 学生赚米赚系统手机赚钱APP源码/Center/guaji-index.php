...
<body>
 ...
 $query = "select count(*) as total from gj";
...
if($_curPageNum < $_pageNum && $_end < $pages){
 ...
 ?>
									<?php 
										$sql="select * from gj ORDER BY `id` DESC  limit $offset,$page_size";
										...
										if($result&&mysql_num_rows($result)){
											...
											echo "<td width='15%'' class='buy_tr'><a href='guaji-del.php?id=".$row['id']."'>删除</a>
											</td>";
											echo "</tr>";
											}
										}
