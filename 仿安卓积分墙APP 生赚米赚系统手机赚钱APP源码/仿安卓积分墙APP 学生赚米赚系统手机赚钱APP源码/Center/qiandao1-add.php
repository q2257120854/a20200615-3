<?php
	...
	if($action=='do'){
		...
		if(!$name||!$file){
	       ...
	       mysql_query($sql);
		   mysql_close();
		   echo "<script>alert('添加成功！');window.location.href='qiandao1-index.php'</script>";
		   die;
		}
	}
		...
		<div id="bg">
			...
			<div id="in_lay">
				...
				<div id="in_con">
					...
					<div id="right">
						<div class="info">
							<div class="info_top"><h2><a href="qiandao1-index.php">返回管理中心</a></h2></div>
							<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="#ffffff" align="center" class="cfBox">
								<tbody>
		   <iframe id="frame_profile" name="frame_profile" style="display: none"></iframe>
           <form action="qiandao1-add.php?action=do" method="post" enctype="multipart/form-data" autocomplete="off" target="frame_profile">
