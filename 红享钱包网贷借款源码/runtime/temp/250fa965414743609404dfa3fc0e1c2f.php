<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/www/wwwroot/123/public/../application/varjoker/view/notice/index.html";i:1535278354;s:61:"/www/wwwroot/123/application/varjoker/view/public/header.html";i:1535373624;s:61:"/www/wwwroot/123/application/varjoker/view/public/footer.html";i:1545506972;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="outter-wp">
    ...
    <div class="graph-visual tables-main">
        ...
        <div class="graph">
            <a class="btn green" data-toggle="modal" data-target="#myModal">添加公告</a>
            <div class="tables">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <form class="form-horizontal" action="<?php echo url('notice/addbroadcast'); ?>" enctype="multipart/form-data" method="post">
    ...
    <script>
        function deld(id) {
        $.get('<?php echo url('notice/deld'); ?>?id='+id,function(rety){
        if(rety.code == 1){
            alert(rety.msg);
            location.reload();
        }else{
