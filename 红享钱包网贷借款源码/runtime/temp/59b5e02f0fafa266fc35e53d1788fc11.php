<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/wwwroot/qumuban.com/public/../application/varjoker/view/pay/putforward.html";i:1541665822;s:64:"/www/wwwroot/qumuban.com/application/varjoker/view/public/header.html";i:1535373624;s:64:"/www/wwwroot/qumuban.com/application/varjoker/view/public/footer.html";i:1545506972;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
        ...
        <div class="graph">
            <form class="form-inline" method="post">
                <div class="form-group">
                    订单查找: <input type="text" class="form-control" name="number" placeholder="订单号"></div>
                <button type="submit" class="btn btn-default">查询</button> </form>提现成功笔数:<?php echo $count; ?>笔，金额<?php echo $money; ?>元
            <div class="tables">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php if($vo['status'] == '1'): ?>审核中<?php else: if($vo['status'] == '2'): ?>已驳回<?php else: ?>已支付<?php endif; endif; ?></td>
                        <td><?php if($vo['status'] == '1'): ?><a href="<?php echo url('pay/successd'); ?>?id=<?php echo $vo['id']; ?>"><span class="label label-primary" >通过</span></a> | <a href="<?php echo url('pay/faild'); ?>?id=<?php echo $vo['id']; ?>"><span class="label label-danger">驳回</span></a><?php else: ?>已提现<?php endif; ?></td>
                    </tr>
