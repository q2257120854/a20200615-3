...
<div class="outter-wp">
    ...
    <div class="graph-visual tables-main">
        ...
        <form class="form-horizontal" action="<?php echo url('setting/xieyi'); ?>" enctype="multipart/form-data" method="post">
