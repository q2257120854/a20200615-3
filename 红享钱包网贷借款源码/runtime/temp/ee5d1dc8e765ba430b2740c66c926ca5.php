<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/www/wwwroot/66/public/../application/varjoker/view/consultation/index.html";i:1540615450;s:60:"/www/wwwroot/66/application/varjoker/view/public/header.html";i:1535373624;s:60:"/www/wwwroot/66/application/varjoker/view/public/footer.html";i:1545506972;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="outter-wp">
    ...
    <div class="graph-visual tables-main">
        ...
        <div class="graph">
            <a class="btn green" data-toggle="modal" data-target="#myModal">添加咨询</a>
            <div class="tables">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <form class="form-horizontal" action="<?php echo url('consultation/addbroadcast'); ?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="key" placeholder="简介" />
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <script>
        function deld(id) {
        $.get('<?php echo url('consultation/deld'); ?>?id='+id,function(rety){
        if(rety.code == 1){
            alert(rety.msg);
            location.reload();
        }else{
        ...
        function editd(ids) {
            $.get('<?php echo url('consultation/editd'); ?>?id='+ids,function(retys){
                $('#editModal').modal();
