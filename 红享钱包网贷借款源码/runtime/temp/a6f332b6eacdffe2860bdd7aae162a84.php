<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\wwwroot\demo.52jscn.com\public/../application/varjoker\view\setting\apiindex.html";i:1535293155;s:71:"D:\wwwroot\demo.52jscn.com\application\varjoker\view\public\header.html";i:1535373625;s:71:"D:\wwwroot\demo.52jscn.com\application\varjoker\view\public\footer.html";i:1545506973;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="outter-wp">
    ...
    <div class="set-1">
        <div class="graph-2 general">
            ...
            <div class="grid-1">
                <div class="form-body">
                    <form class="form-horizontal" action="<?php echo url('setting/saveapi'); ?>" method="post">
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">验证码短信mid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="smsmid" value="<?php echo \think\Config::get('api.smsmid'); ?>">
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">验证码短信appid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="smsappid" value="<?php echo \think\Config::get('api.smsappid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">验证码短信key</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="smskey" value="<?php echo \think\Config::get('api.smskey'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">通知短信mid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="smstmid" value="<?php echo \think\Config::get('api.smstmid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">通知短信appid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="smstappid" value="<?php echo \think\Config::get('api.smstappid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">通知短信key</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="smstkey" value="<?php echo \think\Config::get('api.smstkey'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">支付mid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="paymid" value="<?php echo \think\Config::get('api.paymid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">支付appid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="payappid" value="<?php echo \think\Config::get('api.payappid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">支付key</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="paykey" value="<?php echo \think\Config::get('api.paykey'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">数据查询mid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="datamid" value="<?php echo \think\Config::get('api.datamid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">数据查询appid</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="dataappid" value="<?php echo \think\Config::get('api.dataappid'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
                        ...
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">数据查询key</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control1" name="datakey" value="<?php echo \think\Config::get('api.datakey'); ?>">
                            </div>
                            <div class="col-sm-2">
                                <!--<p class="help-block">Your help text!</p>-->
                            </div>
