<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wwwroot\demo.52jscn.com\public/../application/varjoker\view\pay\vip.html";i:1541665791;s:71:"D:\wwwroot\demo.52jscn.com\application\varjoker\view\public\header.html";i:1535373625;s:71:"D:\wwwroot\demo.52jscn.com\application\varjoker\view\public\footer.html";i:1545506973;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="graph-visual tables-main">
        ...
        <div class="graph">
            <form class="form-inline" method="post">
                ...
                <button type="submit" class="btn btn-default">查询</button> </form>成功笔数：<?php echo $count; ?> 笔，金额<?php echo $money; ?>元
            <div class="tables">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th scope="row"><?php echo $vo['uid']; ?></th>
                        <td>VIP<?php echo $vo['viptype']; ?>开通</td>
                        <td><?php echo $vo['number']; ?></td>
                        <td><?php $datas = db('user')->where('id',$vo['uid'])->find();echo $datas['name']; ?></td>
                      <td><?php echo $vo['money']; ?></td>
                        <td><?php echo $vo['addtime']; ?></td>
                        <td><?php if($vo['status'] == '1'): ?>未支付<?php else: ?>已支付<?php endif; ?></td>
                          </tr>
