<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy_pro\WWW\127.0.0.4\public/../application/varjoker\view\broadcast\index.html";i:1535274408;s:74:"D:\phpstudy_pro\WWW\127.0.0.4\application\varjoker\view\public\header.html";i:1535373624;s:74:"D:\phpstudy_pro\WWW\127.0.0.4\application\varjoker\view\public\footer.html";i:1545506972;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="outter-wp">
            ...
            <div class="tables">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $vo['image']; ?>" style="width: 100px;height: 30px;"></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <form class="form-horizontal" action="<?php echo url('broadcast/addbroadcast'); ?>" enctype="multipart/form-data" method="post">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <form class="form-horizontal" action="<?php echo url('broadcast/editd'); ?>" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">图片上传</label>
                                <div class="col-sm-9">
    ...
    <script>
        function deld(id) {
        $.get('<?php echo url('broadcast/deld'); ?>?id='+id,function(rety){
        if(rety.code == 1){
            alert(rety.msg);
            location.reload();
        }else{
        ...
        function editd(ids) {
            $.get('<?php echo url('broadcast/editd'); ?>?id='+ids,function(retys){
                $('#editModal').modal();
