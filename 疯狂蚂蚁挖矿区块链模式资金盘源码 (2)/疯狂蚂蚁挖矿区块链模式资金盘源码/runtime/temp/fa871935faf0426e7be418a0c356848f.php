<?php /*a:2:{s:72:"D:\phpstudy\PHPTutorial\WWW\demo1\application\admin\view\market\buy.html";i:1537014364;s:74:"D:\phpstudy\PHPTutorial\WWW\demo1\application\admin\view\common\world.html";i:1555433230;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	            ...
	            <tr>
	                ...
	                <td>
	                	...
	                	<a href="/admin/market/transaction.html?id=<?php echo htmlentities($trade['tid']); ?>" class="btn btn-secondary btn-sm">查看</a>
                      	<?php if($trade['status'] == '8'): ?>
							<a href="/admin/market/removemkt.html?id=<?php echo htmlentities($trade['tid']); ?>" class="btn btn-secondary btn-sm">删除</a>				
						<?php endif; ?>
	                </td>
	            </tr>
