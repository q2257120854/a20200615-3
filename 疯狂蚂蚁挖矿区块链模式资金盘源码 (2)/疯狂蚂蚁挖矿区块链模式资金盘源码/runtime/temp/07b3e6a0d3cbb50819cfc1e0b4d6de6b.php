<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\127.0.0.1\application\admin\view\account\edit.html";i:1566132242;s:70:"D:\phpstudy_pro\WWW\127.0.0.1\application\admin\view\common\world.html";i:1574597284;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
            ...
            <div class="card-body">
                <form class="d-block w-100" method="post" action="/admin/account/capital">
                    ...
                    <div class="row">
						...
						<div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="form-label">蚁巢</label>
                                <input type="text" class="form-control" name="poll" placeholder="蚁巢" value="<?php echo htmlentities($user['wallet']['poll']); ?>" />
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="form-label">蚁巢钱包</label>
                                <input type="text" class="form-control" name="mpocket" placeholder="蚁巢钱包" value="<?php echo htmlentities($user['wallet']['mpocket']); ?>" />
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="form-label">可售额度</label>
                                <input type="text" class="form-control" name="cansell" placeholder="可售额度" value="<?php echo htmlentities($user['wallet']['cansell']); ?>" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="text-right">
