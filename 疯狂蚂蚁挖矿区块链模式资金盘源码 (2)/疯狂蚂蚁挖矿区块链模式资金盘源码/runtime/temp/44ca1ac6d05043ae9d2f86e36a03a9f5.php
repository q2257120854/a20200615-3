<?php /*a:2:{s:75:"D:\phpstudy\PHPTutorial\WWW\demo1\application\admin\view\account\index.html";i:1555009837;s:74:"D:\phpstudy\PHPTutorial\WWW\demo1\application\admin\view\common\world.html";i:1555433230;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	    ...
	    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
	        ...
	        <tbody>
	            ...
	            <tr>
                    ...
                    <td class="text-center">
                      <?php if($user['nolimit'] == '0'): ?>
                      <a href="/admin/account/nolimit.html?username=<?php echo htmlentities($user['username']); ?>&type=1" class="btn btn-warning" onclick="return confirm('不限制用户出单数量吗？');">不限制出单</a>
                      <?php else: ?>
                      <a href="/admin/account/nolimit.html?username=<?php echo htmlentities($user['username']); ?>&type=2" class="btn btn-primary " onclick="return confirm('限制用户出单数量吗？');">限制出单</a>
                      <?php endif; ?>
                    </td>
	            </tr>
