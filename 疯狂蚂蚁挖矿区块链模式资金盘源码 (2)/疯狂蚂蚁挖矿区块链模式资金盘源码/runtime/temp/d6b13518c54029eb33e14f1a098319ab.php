<?php /*a:2:{s:65:"/www/wwwroot/url.stak.cn/application/admin/view/news/create.html";i:1566132242;s:66:"/www/wwwroot/url.stak.cn/application/admin/view/common/world.html";i:1566132242;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<form class="card" method="post" enctype="multipart/form-data">
			...
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
		            ...
		            <div class="custom-file">
	                    ...
	                    <label class="custom-file-label">选择图片，可选</label>
                    </div>
		        </div>
			</div>
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
		            ...
		            <input type="text" name="date" class="form-control" placeholder="格式：2018-08-08 12:30:00" />
		        </div>
			</div>
		</div>
	...
	<div class="card-footer text-right">
		<button class="btn btn-primary">提交发布</button>
	</div>
</form>
