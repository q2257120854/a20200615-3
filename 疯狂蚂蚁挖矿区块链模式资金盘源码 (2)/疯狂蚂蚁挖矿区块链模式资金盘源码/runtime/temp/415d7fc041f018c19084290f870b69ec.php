<?php /*a:2:{s:61:"/www/wwwroot/77q73.cn/application/admin/view/store/index.html";i:1530684090;s:62:"/www/wwwroot/77q73.cn/application/admin/view/common/world.html";i:1550219596;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
        ...
        <tbody>
            <?php if(is_array($store) || $store instanceof \think\Collection || $store instanceof \think\Paginator): $i = 0; $__LIST__ = $store;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a href="/admin/store/edit.html?id=<?php echo htmlentities($product['id']); ?>" class="btn btn-secondary btn-sm">编辑</a>
                        <?php if(!(empty($product['username']) || (($product['username'] instanceof \think\Collection || $product['username'] instanceof \think\Paginator ) && $product['username']->isEmpty()))): ?>
                        <a href="/admin/store/remove.html?id=<?php echo htmlentities($product['id']); ?>" onclick="return confirm('确认要删除吗？');" class="btn btn-danger btn-sm">删除</a>
                        <?php endif; ?>
                    </td>
                </tr>
