<?php /*a:2:{s:62:"/www/wwwroot/qiyu.ink/application/admin/view/machine/give.html";i:1526900646;s:62:"/www/wwwroot/qiyu.ink/application/admin/view/common/world.html";i:1555285885;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="page">
	<div class="page-single">
		<form class="card" method="post" style="max-width: 50rem;" enctype="multipart/form-data">
			<div class="card-body">
				<div class="card-title">一键批量赠送蚁后</div>
				<div class="card-subtitle">赠送的蚁后不会扣除用的钱，其他和正常购买一样。</div>
				<div class="card-subtitle">如赠送失败，只需要再次尝试即可。</div>
				<div class="card-subtitle">已冻结的账号也会进行赠送。</div>
				<div class="row">
					<div class="col-sm-12">
                    	<div class="form-group">
                            <label class="form-label">蚁后类型</label>
