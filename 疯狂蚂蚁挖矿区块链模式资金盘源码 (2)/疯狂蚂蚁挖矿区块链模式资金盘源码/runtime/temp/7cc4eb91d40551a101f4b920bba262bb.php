<?php /*a:2:{s:75:"D:\phpstudy\PHPTutorial\WWW\demo1\application\admin\view\index\setting.html";i:1531214896;s:74:"D:\phpstudy\PHPTutorial\WWW\demo1\application\admin\view\common\world.html";i:1555433230;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<form class="card" method="post">
    ...
    <div class="card-body">
        <div class="form-group">
            <label class="form-label">推广一人 系统赠送</label>
            <input type="number" name="invit_money" class="form-control" value="<?php echo htmlentities($setting['invit_money']); ?>">
        </div>
    </div>
