<?php /*a:2:{s:62:"/www/wwwroot/77q73.cn/application/admin/view/machine/edit.html";i:1526899308;s:62:"/www/wwwroot/77q73.cn/application/admin/view/common/world.html";i:1550219596;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="page">
	<div class="page-single">
		<form class="card" method="post" style="max-width: 50rem;" enctype="multipart/form-data">
			...
			<div class="card-body">
				<div class="card-title">编辑用户的蚁后</div>
				<div class="card-subtitle">修改用户蚁后的某些属性会产生一些意想不到的问题，例如：</div>
				<div class="card-subtitle">算力：购买时赠送了用户10个算力，现在将这台蚁后的算力改为8个，那么该用户的算力还是10个，并不会减去。</div>
				<div class="card-subtitle">周期和预计收入：假如用户已经超过了新修改的数值。</div>
				<div class="card-subtitle">等等问题，总而言之，已产生的数据不会消失</div>
				<div class="row">
				    <div class="col-sm-6">
				        <div class="form-group">
				            <label class="form-label">蚁后名称</label>
				            <input type="text" class="form-control" name="name" placeholder="蚁后名称" value="<?php echo htmlentities($machine['name']); ?>" />
				        </div>
				    </div>
				    <div class="col-sm-6">
				        <div class="form-group">
				            <label class="form-label">蚁后状态</label>
                    ...
                    <div class="col-sm-12">
                    	<div class="form-group">
                            ...
                            <select class="form-control custom-select" name="divide">
                            	<?php $__FOR_START_1845407069__=0;$__FOR_END_1845407069__=9;for($i=$__FOR_START_1845407069__;$i < $__FOR_END_1845407069__;$i+=1){ if($machine['divide'] == $i): ?>
				    ...
				    <div class="col-sm-6">
				        <div class="form-group">
				            <label class="form-label">蚁后价格</label>
				            <input type="text" class="form-control" name="price" placeholder="蚁后价格" value="<?php echo htmlentities($machine['price']); ?>" />
				        </div>
				    </div>
				    <div class="col-sm-6">
				        <div class="form-group">
