<?php /*a:2:{s:63:"/www/wwwroot/url.stak.cn/application/admin/view/news/edit.html";i:1567770370;s:66:"/www/wwwroot/url.stak.cn/application/admin/view/common/world.html";i:1567716346;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<form class="card" method="post" enctype="multipart/form-data">
	...
	<div class="card-header">
		...
		<div class="card-options">
			<a class="btn btn-primary btn-sm" href="/admin/news/index.html">返回列表</a>
		</div>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
		            ...
		            <input type="text" name="title" class="form-control" value="<?php echo htmlentities($article['title']); ?>" />
		        </div>
			</div>
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
			...
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
		            <label class="form-label">公告时间</label>
		            <input type="text" name="date" class="form-control" placeholder="格式：2018-08-08 12:30:00" value="<?php echo htmlentities($article['date']); ?>" />
		        </div>
			</div>
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
		            <label class="form-label">排列顺序</label>
		            <input type="text" name="sort" class="form-control" placeholder="数字越大越靠前" value="<?php echo htmlentities($article['sort']); ?>" />
		        </div>
			</div>
			<div class="col-sm-12 col-lg-4">
				<div class="form-group">
		            ...
		            <select name="top" class="form-control">
		            	<?php if($article['top'] == '1'): ?>
			            	...
			            	<option selected="true" value="1">置顶</option>
		            	<?php else: ?>
		            		<option value="0">不置顶</option>
...
<script src="/static/jyjs/skin/default/css.php"></script>
