<?php /*a:2:{s:63:"/www/wwwroot/77q73.cn/application/index/view/machine/index.html";i:1551537585;s:62:"/www/wwwroot/77q73.cn/application/index/view/common/world.html";i:1551429184;}*/ ?>
...
<div class="buttons-tab">
    <a href="machine.html" class="active button">正常蚁后</a>
    <a href="machine.html?type=2" class=" button">到期蚁后</a>
</div>
            ...
            <?php if(is_array($running) || $running instanceof \think\Collection || $running instanceof \think\Paginator): $i = 0; $__LIST__ = $running;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$machine): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td align="center" valign="middle">
                        <img src="/store/<?php echo htmlentities($machine['mimg']); ?>" width="60">
                    ...
                    <td align="center" valign="middle">工作中</td>
                </tr>
