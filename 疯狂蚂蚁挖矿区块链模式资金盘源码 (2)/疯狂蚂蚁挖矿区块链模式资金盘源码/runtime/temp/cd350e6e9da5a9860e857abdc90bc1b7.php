<?php /*a:2:{s:58:"D:\wwwroot\application\admin\view\event\funding_audit.html";i:1566132242;s:51:"D:\wwwroot\application\admin\view\common\world.html";i:1578897798;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="d-flex">
    <div class="btn-list">
        <a href="/admin/event/funding.html" class="btn btn-secondary">内排中心</a>
        <a href="/admin/event/funding_audit.html" class="btn btn-primary">内排审核</a>
            ...
            <tbody>
                <?php if(is_array($logs) || $logs instanceof \think\Collection || $logs instanceof \think\Paginator): $i = 0; $__LIST__ = $logs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td><?php echo htmlentities(money($log['money'])); ?></td>
                        <td><img src="<?php echo htmlentities($log['image']); ?>" width="120px"></td>
                        <td><?php echo htmlentities(money($log['price'])); ?></td>
                        <td><?php echo htmlentities($log['create_at']); ?></td>
                        <td>
                            <?php switch($log['status']): case "1": ?>
                            <span style="color:#467fcf">已通过</span>
                            <?php break; case "2": ?>
                            <span style="color:red">已拒绝</span>
                            <?php break; default: ?>
                            <a href="/admin/event/successfa.html?id=<?php echo htmlentities($log['id']); ?>" class="btn btn-secondary btn-sm">通过</a>
                            <a href="/admin/event/refusefa.html?id=<?php echo htmlentities($log['id']); ?>" class="btn btn-secondary btn-sm">拒绝</a>
                            <?php endswitch; ?>
                        </td>
                    </tr>
