<?php /*a:2:{s:63:"/www/wwwroot/77q73.cn/application/admin/view/account/index.html";i:1548649704;s:62:"/www/wwwroot/77q73.cn/application/admin/view/common/world.html";i:1550219596;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	        ...
	        <tbody>
	            ...
	            <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="/admin/account/nolimit.html?username=<?php echo htmlentities($user['username']); ?>" class="btn btn-secondary btn-sm" onclick="return confirm('不限制用户出单数量吗？');">不限制出单</a>
                      <?php else: ?>
                      <span class="status-icon bg-success"></span>不限制
                      <?php endif; ?>
                    </td>
	            </tr>
