     ...
     // print_r($tplist1);
       ...
       // print_r($tksign);
		...
		if (checksubmit()) {
			...
			$cfg = array(
			'ddorrmsg'=>htmlspecialchars_decode(str_replace('&quot;','&#039;',$_GPC['ddorrmsg']),ENT_QUOTES),
			'txkechuyj'=>$_GPC['txkechuyj'],
			    'heitzurl'=>$_GPC['heitzurl'],
				...
				'tzhtjerror1' =>htmlspecialchars_decode(str_replace('&quot;','&#039;',$_GPC ['tzhtjerror1']),ENT_QUOTES),
				...
				'pddwenan' => htmlspecialchars_decode(str_replace('&quot;','&#039;',$_GPC ['pddwenan']),ENT_QUOTES),
				'wphwenan' => htmlspecialchars_decode(str_replace('&quot;','&#039;',$_GPC ['wphwenan']),ENT_QUOTES),
				'snwenan' => htmlspecialchars_decode(str_replace('&quot;','&#039;',$_GPC ['snwenan']),ENT_QUOTES),
