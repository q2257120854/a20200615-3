<?php
      ...
      $cfg = $this->module['config'];
		...
		if($_GPC['yyqd']==1){
			if(!empty($qdid)){
				$rhyurl="https://mos.m.taobao.com/taokeapp/wishes/square.html?union_lens=f%3Dn&pid=".$pid."&relationId=".$qdid;
			}else{
				$rhyurl="https://mos.m.taobao.com/taokeapp/wishes/square.html?union_lens=f%3Dn&pid=".$pid;
			}
			
			$pic="https://img.tigertaoke.com/images/14/2019/10/nN4NNoH135t5ncH4CSqZ14Q6H1pQno.jpg";
			$title="晒双11愿望清单,助力赢奖励";
		}
