...
class HtOrderStatusCancelServiceClient{
	...
	public static function getService(){
		...
		if (! HtOrderStatusCancelServiceClient::$isRegis){
			
			HtOrderStatusCancelServiceClient::regis ();
			HtOrderStatusCancelServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtOrderStatusCancelServiceClient::$DEFAULT_PROXY_IP;
		$port = HtOrderStatusCancelServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\haitao\order\osp\service\HtOrderStatusCancelServiceHelper();
	}
