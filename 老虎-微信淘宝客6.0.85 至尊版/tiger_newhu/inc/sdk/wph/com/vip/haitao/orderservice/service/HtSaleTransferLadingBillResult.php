...
class HtSaleTransferLadingBillResult {
	...
	public function getName(){
		...
		return 'HtSaleTransferLadingBillResult';
	}
			...
			if ("interBatchNos" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\haitao\orderservice\service\InterBatchNoVo();
						$elem0->read($input);
						
						$this->interBatchNos[$_size0++] = $elem0;
					}
					catch(\Exception $e){
