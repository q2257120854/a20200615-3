	...
	public function read($input){
		...
		while(true){
			...
			if ("header" == $schemeField){
				...
				$this->header = new \com\vip\haitao\base\osp\service\record\VipGoodRecordHeader();
			...
			if ("dataList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\haitao\base\osp\service\record\VipGoodRecordModel();
						$elem0->read($input);
