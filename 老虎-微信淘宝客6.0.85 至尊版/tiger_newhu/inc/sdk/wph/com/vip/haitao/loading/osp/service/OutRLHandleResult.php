	...
	public function read($input){
		...
		while(true){
			...
			if ("header" == $schemeField){
				...
				$this->header = new \com\vip\haitao\loading\osp\service\PostHeader();
			...
			if ("body" == $schemeField){
				...
				$this->body = new \com\vip\haitao\loading\osp\service\GetBody();
