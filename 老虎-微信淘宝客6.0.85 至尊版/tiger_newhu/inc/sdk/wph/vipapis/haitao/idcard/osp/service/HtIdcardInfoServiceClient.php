...
class HtIdcardInfoServiceClient{
	...
	public static function getService(){
		...
		if (! HtIdcardInfoServiceClient::$isRegis){
			
			HtIdcardInfoServiceClient::regis ();
			HtIdcardInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtIdcardInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = HtIdcardInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\haitao\idcard\osp\service\HtIdcardInfoServiceHelper();
	}
