...
class HtLoadingServiceClient{
	...
	public static function getService(){
		...
		if (! HtLoadingServiceClient::$isRegis){
			
			HtLoadingServiceClient::regis ();
			HtLoadingServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtLoadingServiceClient::$DEFAULT_PROXY_IP;
		$port = HtLoadingServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\loading\HtLoadingServiceHelper();
	}
