...
class HtVopFetchPackageIServiceClient{
	...
	public static function getService(){
		...
		if (! HtVopFetchPackageIServiceClient::$isRegis){
			
			HtVopFetchPackageIServiceClient::regis ();
			HtVopFetchPackageIServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtVopFetchPackageIServiceClient::$DEFAULT_PROXY_IP;
		$port = HtVopFetchPackageIServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\order\HtVopFetchPackageIServiceHelper();
	}
