...
class HtSaleTransferBatchNoIfaceServiceClient{
	...
	public static function getService(){
		...
		if (! HtSaleTransferBatchNoIfaceServiceClient::$isRegis){
			
			HtSaleTransferBatchNoIfaceServiceClient::regis ();
			HtSaleTransferBatchNoIfaceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtSaleTransferBatchNoIfaceServiceClient::$DEFAULT_PROXY_IP;
		$port = HtSaleTransferBatchNoIfaceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\order\HtSaleTransferBatchNoIfaceServiceHelper();
	}
