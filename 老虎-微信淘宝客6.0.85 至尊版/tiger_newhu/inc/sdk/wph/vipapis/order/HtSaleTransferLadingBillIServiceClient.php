...
class HtSaleTransferLadingBillIServiceClient{
	...
	public static function getService(){
		...
		if (! HtSaleTransferLadingBillIServiceClient::$isRegis){
			
			HtSaleTransferLadingBillIServiceClient::regis ();
			HtSaleTransferLadingBillIServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtSaleTransferLadingBillIServiceClient::$DEFAULT_PROXY_IP;
		$port = HtSaleTransferLadingBillIServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\order\HtSaleTransferLadingBillIServiceHelper();
	}
