...
class HtGoodRecordServiceClient{
	...
	public static function getService(){
		...
		if (! HtGoodRecordServiceClient::$isRegis){
			
			HtGoodRecordServiceClient::regis ();
			HtGoodRecordServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtGoodRecordServiceClient::$DEFAULT_PROXY_IP;
		$port = HtGoodRecordServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\hts\HtGoodRecordServiceHelper();
	}
