...
class HtFeedbackMessageServiceClient{
	...
	public static function getService(){
		...
		if (! HtFeedbackMessageServiceClient::$isRegis){
			
			HtFeedbackMessageServiceClient::regis ();
			HtFeedbackMessageServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtFeedbackMessageServiceClient::$DEFAULT_PROXY_IP;
		$port = HtFeedbackMessageServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\haitaoervice\HtFeedbackMessageServiceHelper();
	}
