...
class HtSaleOrderVopServiceClient{
	...
	public static function getService(){
		...
		if (! HtSaleOrderVopServiceClient::$isRegis){
			
			HtSaleOrderVopServiceClient::regis ();
			HtSaleOrderVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtSaleOrderVopServiceClient::$DEFAULT_PROXY_IP;
		$port = HtSaleOrderVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\orderservice\service\HtSaleOrderVopServiceHelper();
	}
