...
class HtRecevieCustomsDeclarationStatusIfaceServiceClient{
	...
	public static function getService(){
		...
		if (! HtRecevieCustomsDeclarationStatusIfaceServiceClient::$isRegis){
			
			HtRecevieCustomsDeclarationStatusIfaceServiceClient::regis ();
			HtRecevieCustomsDeclarationStatusIfaceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = HtRecevieCustomsDeclarationStatusIfaceServiceClient::$DEFAULT_PROXY_IP;
		$port = HtRecevieCustomsDeclarationStatusIfaceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\orderservice\service\HtRecevieCustomsDeclarationStatusIfaceServiceHelper();
	}
