...
<?php
	...
	if($sitename==null){
		...
		$sds=$DB->query("update shua_site set sitename='$sitename',title='$title',keywords='$keywords',description='$description',anounce='$anounce',modal='$modal',bottom='$bottom',ktfz_price='$ktfz_price',ktfz_price2='$ktfz_price2',ktfz_domain='$ktfz_domain',template='$template' where zid='{$userrow['zid']}'");
...
实用工具：<a href="uset.php?mod=copygg">一键复制其他站点排版</a>
</div>
</div>
<?php
	...
	if(array_key_exists('sitename',$arr)){
		...
		showmsg('获取数据失败，对方网站无法连接或非冰狱防红系统。',4);
	}
}elseif($mod=='copygg'){
?>

<div class="panel panel-default">
<div class="panel-heading font-bold" style="background-color: #9999CC;color: white;" >一键复制其它站点排版</div>
<div class="panel-body">
