...
<div class="container" style="padding-top:10px;">
	...
	<tbody>
		<tr>
			<td><a href="../" class="btn btn-success btn-sm btn-block">自助防红</a></td>
			<td><a href="./temp.php" class="btn btn-info btn-sm btn-block">接口列表</a></td>
			<td><a href="./hbmd.php" class="btn btn-primary btn-sm btn-block">黑白名单</a></td>
		</tr>
		<tr>
		
		
			<td><a href="./ggao.php" class="btn btn-info btn-sm btn-block">生成记录</a></td>
			<?php if($userrow['power']==1){?>
			<td><a href="./sitelist.php" class="btn btn-warning btn-sm btn-block">旗下分站</a></td>
			<?php }else{?>
			<td><a href="./sygg.php" data-toggle="modal" class="btn btn-warning btn-sm btn-block">访问记录</a></td>
			<?php }?>
