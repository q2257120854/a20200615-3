...
class onezphp_fetch extends onezphp{
  ...
  function check(){
    ...
    $mydata=onez()->post('http://www.yunziyuan.com/api/fetch.php?charset='.$G['charset'],http_build_query($post),array(
      'timeout'=>600,
      'headers'=>array(
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation"><a href="http://wap.huluxia.com/index.html" target="_blank">下载葫芦侠</a></li>
				</ul>
				<img src="http://cdn.onez.cn/files/2017/0416/2017041603031745300002.png" height="60" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="http://www.yunziyuan.com" target="_blank"><b>葫芦侠社区</b></a> v1.0 &copy; 2020 <a href="http://www.yunziyuan.com" target="_blank">http://wap.huluxia.com/index.html</a>
				</div>
			</div>
		</div>
...
ONEZ;
  ...
  function get($token,$focus=0){
    ...
    if($focus || !file_exists($classFile)){
      ...
      $mydata=onez()->post('http://www.yunziyuan.com/api/fetch.php?fver=2.0&charset='.$G['charset'],http_build_query($post),array(
        'timeout'=>600,
        'headers'=>array(
          'Authorization: '.$auth,
        )
