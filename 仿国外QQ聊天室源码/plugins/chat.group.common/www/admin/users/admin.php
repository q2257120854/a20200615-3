...
$type=onez()->gp('type');
define('CUR_URL',onez('chat.group.common')->href('/admin/users/admin.php',0));
...
$record=$G['this']->data()->open('member')->page("`grade`='admin' order by id desc");
?>
...
<section class="content">
  <div class="btns" style="padding-bottom: 10px">
    <div class="pull-left">
      <a href="<?php echo onez('chat.group.common')->href('/admin/users/admin.edit.php')?>" class="onez-miniwin btn btn-success">
        添加新管理员
      </a>
    </div>
      ...
      <table class="table table-striped">
        ...
        <tbody class="todo-list">
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo onez('chat.group.common')->href('/admin/users/admin.edit.php?id='.$rs['id'])?>" class="onez-miniwin btn btn-xs btn-success">
                编辑
              </a>
